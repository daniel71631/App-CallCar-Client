...
public class carstoreActivity extends AppCompatActivity {
    ...
    private SQLitecarstore dbHelper = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carstore);

        dbHelper = new SQLitecarstore(this);
        lv_main = (ListView) findViewById(R.id.listView_main);
        emptyText = (TextView) findViewById(R.id.textView_empty);
        totalList = getcontent();
        adapter = new SimpleAdapter(this, totalList, R.layout.item_listview_main2, new String[]{"phonenumber", "username"},
        ...
        mtoolbar.inflateMenu(R.menu.main_carstore);
        mtoolbar.setTitle("車行電話");
        mtoolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_insert:
                        AlertDialog.Builder builder_insert = createAlertDialog(android.R.drawable.ic_dialog_alert, "新增車行電話");
                        ...
                        builder_insert.setPositiveButton("確定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (name.equals("") || number.equals("")) {
                                    ...
                                    String sql = "insert into tb_carstore(username, phonenumber)values(?,?)";
                    ...
                    case R.id.friendnumber:
                        startActivity(new Intent(carstoreActivity.this,PhonebookActivity.class));
                        break;
                    case R.id.drivernumber:
                        startActivity(new Intent(carstoreActivity.this,drivernumActivity.class));
                        break;
                }
                return false;
            }
    ...
    private List<Map<String, Object>> getcontent() {
        return dbHelper.selectList("select * from tb_carstore", null);
    }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        getMenuInflater().inflate(R.menu.contentmenu_listview_maincartsore, menu);
        ...
        switch (item.getItemId()) {
            case R.id.action_delete:
                ...
                builder_dele.setPositiveButton("刪除", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String sql = "delete from tb_carstore where _id=?";
            ...
            case R.id.action_update:
                AlertDialog.Builder builder_update = createAlertDialog(android.R.drawable.ic_dialog_alert, "修改車行電話資料");
                ...
                builder_update.setPositiveButton("確認", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String sql = "update tb_carstore set username=? , phonenumber=? where _id=?";
    ...
    protected void toast(String string) {
        Toast.makeText(carstoreActivity.this, string, Toast.LENGTH_LONG).show();
    }
