...
public class PhonebookActivity extends AppCompatActivity {
    ...
    private SQLitePhonebook dbHelper = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new SQLitePhonebook(this);
        lv_main = (ListView) findViewById(R.id.listView_main);
        emptyText = (TextView) findViewById(R.id.textView_empty);
        totalList = getcontent();
        adapter = new SimpleAdapter(this, totalList, R.layout.item_lisetview_main, new String[]{"phonenumber", "username"},
        ...
        mtoolbar.setTitle("常用聯絡人");
        mtoolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_insert:
                        AlertDialog.Builder builder_insert = createAlertDialog(android.R.drawable.ic_dialog_alert, "新增聯絡人");
                        ...
                        builder_insert.setPositiveButton("確定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (name.equals("") || number.equals("")) {
                                    ...
                                    String sql = "insert into tb_trycontact(username, phonenumber)values(?,?)";
                    ...
                    case R.id.carstorenum:
                        startActivity(new Intent(PhonebookActivity.this,carstoreActivity.class));
                        break;
                    case R.id.drivernumber:
                        startActivity(new Intent(PhonebookActivity.this,drivernumActivity.class));
                        break;
                }
               return false;
            }
        ...
        private List<Map<String, Object>> getcontent() {
            return dbHelper.selectList("select * from tb_trycontact", null);
        }
            ...
            switch (item.getItemId()) {
                case R.id.action_delete:
                    ...
                    builder_dele.setPositiveButton("删除", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            String sql = "delete from tb_trycontact where _id=?";
                ...
                case R.id.action_update:
                    AlertDialog.Builder builder_update = createAlertDialog(android.R.drawable.ic_dialog_alert, "修改聯絡人資料");
                    ...
                    builder_update.setPositiveButton("確認", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            String sql = "update tb_trycontact set username=? , phonenumber=? where _id=?";
        ...
        protected void toast(String string) {
            Toast.makeText(PhonebookActivity.this, string, Toast.LENGTH_LONG).show();
        }
