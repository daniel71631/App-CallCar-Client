...
public class SQLitelogin extends SQLiteOpenHelper {
    private final static String DB_NAME = "db_login.db";
    private final static int VERSION = 1;
    public SQLiteDatabase dbConn;

    public SQLitelogin(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table if not exists tb_login(_id integer primary key autoincrement , loginuseremail , loginpassword)");
    }
